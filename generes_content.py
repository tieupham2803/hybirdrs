...
def make_chart(genre, percentile=0.85):
    ...
    return qualified
print('top Comedy')
print(make_chart('Comedy').head(15))
# print('Top romance')
# print(make_chart('Romance'))
...
# ratings.to_csv('newratings.csv', sep=',', encoding='utf-8')
ratings = ratings[(ratings['userId'])<=30454]
print(ratings.shape)
ratings = ratings[ratings['movieId'].isin(tmdbid)]
# print(ratings['userId'].drop_duplicates().shape)
ratings.to_csv('newratings.cosine_simv', sep=',', encoding='utf-8')
print(ratings.shape)
quit()
