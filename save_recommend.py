...
md = pd.read_csv('movies_metadata.csv',encoding='utf8') # Doc du lieu vao dataframe
print(list(md))
print(md.shape)
#print(md.head(5))
...
# smd.to_csv('data_item_base_frame.csv', sep=',', encoding='utf-8')
# print(smd.shape)
...
# print(get_recommendations('Grown Ups 2').head(20))
#### end of contentbased
########### begin metadata recommender
print('asddass')
credits = pd.read_csv('credits.csv',encoding='cp1252')
...
cosine_sim = np.load('maximums.npy')
print(type(cosine_sim))
# outfile = TemporaryFile()
# # np.save(outfile, cosine_sim)
# np.savetxt('test1.txt', cosine_sim, fmt='%f')
# np.save('maximums.npy', cosine_sim)
# quit()
smd = smd.reset_index()
titles = smd['title']
indices = pd.Series(smd.index, index=smd['title'])
term = smd['soup']
# term.to_csv('soup.csv', sep=',', encoding='utf-8')
print(term.head(10))
# quit()
...
print('trungkhanh sam lam')
print(hybrid(1, 'Chungking Express'))
# print(svd.predict())